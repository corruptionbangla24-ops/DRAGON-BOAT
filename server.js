...
// 💰 ১. লাইভ অ্যাকাউন্ট ব্যালেন্স ইন্টারসেপ্টর গেটওয়ে (মানি ট্রি হুবহু ট্র্যাপ ফলব্যাক সিঙ্ক)
...
app.post('/api/dragonboat-spin', async (req, res) => {
    ...
    try {
        // 🔒 [🔒 ওরিজিনাল মানি ট্রি সিঙ্গেল এন্ট্রি বাউন্সার]: ডাবল কলব্যাকের ট্র্যাপ উপড়ে ফেলে সরাসরি ১ম হিটে বাজি ডেবিট রিকোয়েস্ট ফায়ার লক ওস্তাদ!
        // ডাটাবেজ নিজেই রিয়েল-টাইমে টাকা চেক করে যদি দেখে প্লেয়ারের সাফ ব্যালেন্স নাই, সে এখান থেকেই সরাসরি জেনুইন রিজেক্ট রেসপন্স ছুড়বে ভাই ভাই!
        ...
        // 🎰 [🎰 ফ্যান-টান ও মানি ট্রি স্ট্যান্ডার্ডে তৈরি পিউর জেনুইন ৯৫% RTP লুপ ইঞ্জিন ভাই ভাই]
        while (isLoopActive && loopSafety < 150) {
            ...
            if (balResponse.data && balResponse.data.dragonboat_target) {
                ...
                if (finalStatus === "win") {
                    // ফ্যান-টান হুবহু ট্র্যাকে আরটিপি ২২% এ সুষম ব্যালেন্সড লক ভাই ভাই!
        ...
        if (winMultiplier > 0) {
            ...
            dbAction = "win"; dbAmount = 0; // 🔒 லস হলে ডাটাবেজে ২য় বার টাকা কাটার ট্র্যাপ এরর ওয়ান-শটে ওড়াও সাফ!
        }
